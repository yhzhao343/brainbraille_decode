...
class BrainBrailleCVGen():
    ...
    def sub_adaptive_leave_one_sub_out_test_sub(self, sub=1, n_adapt=1, max_fold_num=200):
        train_list, test_list, adapt_list = self.sub_independent_leave_one_sub_out_with_calib_test_sub(sub, n_adapt, max_fold_num)
    ...
    def sub_adaptive_leave_one_sub_out(self, n_adapt=1, max_fold_num=200):
        ...
        for sub_i in unique_subs:
            train_i, test_i = self.sub_adaptive_leave_one_sub_out_test_sub(sub_i, n_adapt, max_fold_num)
    ...
    def sub_independent_leave_one_sub_out_with_calib_test_sub(self, sub=1, n_calib=1, max_fold_num=200):
        test_list, calib_list = self.sub_dependent_leave_n_run_out(sub, n_calib, max_fold_num)
    ...
    def sub_independent_leave_one_sub_out_with_calib(self, sub=1, n_calib=1, max_fold_num_each=200):
        ...
        calib_index_list = []
        for sub_i in unique_subs:
            train_list_i, test_list_i, calib_list_i = self.sub_independent_leave_one_sub_out_with_calib_test_sub(sub_i)
